...
def g():
    ...
    flower_url = "https://repo.hops.works/master/hopsworks-tutorials/data/iris/" + flower + ".png"
    ...
    label_url = "https://repo.hops.works/master/hopsworks-tutorials/data/iris/" + label + ".png"
